...
[![Thumbnail for my projet](Thumbnail.png)]([[youtube-URL-here](https://youtu.be/mgDZCA_YFH8)](

## Story Description

My project showcases images of cars I have taken and expresses them using 4 different filters. Filters I used are Negative, Sepia, colorize, and sharpen. These photos are listeded in 4 different catagories with each of its brand, Jeep, Lambo, Ferrari, and BMW.  My first 2D array explains the cars brand and the images of the cars. My second 2D array shows the car brand and the average top speed of each of the cars. 

## Image Filter Analysis

The first filter is a negative image filter. This filter flips the RGB colors to negative for example 250 would become -250. This filter makes dark colors brighter and brighter colors darker. My second image filter I used is the sharpen image filter. This image filter creates a outline between the colors making the brighter colors brighter and the darker colors darker making it pop more and create a sharper look. This image filter works by choosing its colors based off its neighbors pixel color or RGB color. 
